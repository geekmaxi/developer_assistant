        ...
        <div className="text-white flex flex-wrap items-center">
          ...
          {messages.length > 0 ? (
              <a
                ...
                target="_blank"
                className="text-white flex items-center pl-4"
              >
                <img src="/images/github-mark.svg" className="h-6 mr-1" />
              </a>
          ) : (
            ""
          )}
